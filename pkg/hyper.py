...
class Hyper:
    ...
    # dir
    root_dir = "/mnt/data1/home/a.s.potapov/projects/stt_experiments/"
    ...
    vocab = "PE абвгдежзийклмнопрстуфхцчшщъыьэюяё'!,.?"
    data_max_text_length = 800
    ...
    batch_size = 32
    num_batches = 1000000
    device_text2mel = "cuda:2"
    device_superres = "cuda:2"
